...
void pvInfo() {
	...
	printf("Tamaño pdata (struct pilainfo):\t%ld bytes\n", sizeof(tdata));
	printf("Tamaño pila == array pdata[50]:\t%ld bytes\n", sizeof(tpila));
	printf("Tamaño pv (struct pilavector):\t%ld bytes\n", sizeof(tpv));
	printf("== == == == == == == == == == == == == == ==\n\n");
}
...
int main() {
	...
	a3 = pop();
    printf("pop retorna ID: %d; matrícula: %s; dni: %s; nombre: %s; mail: %s\n", a3.id, a3.matricula, a3.dni, a3.nombre, a3.mail);
	display();
	printf("\n================\n\n");
